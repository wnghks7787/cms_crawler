...
then
    python "$SCRIPT_DIR/playwright_builder/joomla_autobuilder.py" --portnum $PORT --version $VERSION
elif [ "$REPO" == 'drupal' ];
then
    python "$SCRIPT_DIR/playwright_builder/drupal_autobuilder.py" --portnum $PORT --version $VERSION
